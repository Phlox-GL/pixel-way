...
{} (:about "|file is generated - never edit directly; learn cr edit/tree workflows before changing") (:package |app)
  ...
  :files $ {}
                    ...
                    container
                      ...
                      text $ {} (:text "|Take a rest.")
                        ...
                        :style $ {}
                          ...
                          :font-family "|Josefin Sans"
          :examples $ []
        |gap $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
            def gap $ / 1 15
          :examples $ []
        |on-reset $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
            defn on-reset (d!)
              let
                  x 60
          ...
          :examples $ []
        |on-touch $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
    ...
    |app.page $ %{} :FileEntry
      :defs $ {}
        |base-info $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
            def base-info $ {}
              ...
              :inline-html nil
          :examples $ []
        |dev-page $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
        ...
        |main! $ %{} :CodeEntry (:doc |) (:schema nil)
          ...
          :examples $ []
        |prod-page $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
            defn prod-page () $ let
    ...
    |app.updater $ %{} :FileEntry
      :defs $ {}
        |load-in $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
            defn load-in (xs pair)
              let[] (i j) pair $ if (&list:contains? xs i)
                ...
                , nil
          :examples $ []
        |turn-grids $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
                ...
                if
                  ...
                  , store $ let
                    ...
                    if
                      ...
                      , next-store
          :examples $ []
        |undulate-grids $ %{} :CodeEntry (:doc |) (:schema nil)
          :code $ quote
